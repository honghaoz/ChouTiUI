...
- Never add noisy documentation/comments that restate what the code or an adjacent directive already conveys (e.g. explaining a lint-disable directive that already names the rule). Comments must add non-obvious information.
